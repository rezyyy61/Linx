...
const PostsListPage = () => import("@/modules/dashboard/pages/posts/PostsListPage.vue");
const PostsCreatePage = () => import("@/modules/dashboard/pages/posts/PostsCreatePage.vue");
const PostsEditPage = () => import("@/modules/dashboard/pages/posts/PostsEditPage.vue");
...
export default {
  ...
  children: [
    ...
    { path: "posts", name: "posts.list", component: PostsListPage, meta: { permission: "posts.view" } },
    { path: "posts/create", name: "posts.create", component: PostsCreatePage, meta: { permission: "posts.create" } },
    { path: "posts/:id/edit", name: "posts.edit", component: PostsEditPage, meta: { permission: "posts.edit" } },

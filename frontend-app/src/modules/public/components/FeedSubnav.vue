...
<template>
  <nav class="mx-auto w-[70%]">
    <div
        class="mx-4 rounded-xl border border-gray-200 bg-white/70 backdrop-blur px-2 py-2 shadow-sm
             dark:border-zinc-800 dark:bg-zinc-900/70"
    >
      <ul
          class="flex gap-2 items-center whitespace-nowrap overflow-x-auto justify-start
               md:justify-center md:flex-wrap md:overflow-visible md:whitespace-normal no-scrollbar"
      >

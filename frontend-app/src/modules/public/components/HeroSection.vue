...
<template>
  <section class="text-center py-12 sm:py-16">
    ...
    <p
      class="mt-3 text-base text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed"
    >
    ...
    <div class="mt-6 flex flex-wrap items-center justify-center gap-3">
      ...
      <template v-else>
        <span
          class="inline-flex items-center rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-800 dark:bg-zinc-800 dark:text-zinc-100"
        >
